...
@section('meta')
    ...
    <meta property="og:url" content="{{ route('category.blogs', $category->slug) }}" />
        ...
        <div class="trawell-cover-item item-overlay trawell-item-color-overlay trawell-flex align-items-center justify-content-center text-center ">
            ...
            <div class="entry-image">
                <img width="1920" height="1280"
                     src="{{ uploaded_asset($category->meta_img) }}"
                     class="attachment-trawell-cover size-trawell-cover"
                     alt="{{ $category->meta_title }}" loading="lazy" /></div>


            <div class="archive-heading trawell-entry">
                <h1 class="archive-title h1 md-h1 sm-h1">{{ $category->name }}</h1>
            ...
            <div class="trawell-section trawell-layout-b1">
                <div class="container">
                    <div class="row trawell-posts">
                        ...
                        @endforeach
                        @if ($category->posts->links()->paginator->hasPages())
