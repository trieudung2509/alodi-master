            ...
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="{{ route('category.store') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" name="show_on_home_page" id="show_on_home_page" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea data-min-height="800" name="description" class="aiz-text-editor" data-format="true"></textarea>
                        </div>
                    </div>
