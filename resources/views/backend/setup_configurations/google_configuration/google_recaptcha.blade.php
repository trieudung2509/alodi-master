                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('google_recaptcha.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="control-label">{{translate('Site SECRET')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="CAPTCHA_SECRET" value="{{  env('CAPTCHA_SECRET') }}" placeholder="{{ translate('Site SECRET') }}" required>
                            </div>
                        </div>
