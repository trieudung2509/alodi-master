    ...
    <div class="card-body">
        <form id="sort_uploads" action="">
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control form-control-xs" name="width" placeholder="{{ translate('Search by width') }}" value="{{ $sort_width }}">
                </div>
                <div class="col-md-3">
                    <input type="text" class="form-control form-control-xs" name="height" placeholder="{{ translate('Search by height') }}" value="{{ $sort_height }}">
                </div>
            </div>
