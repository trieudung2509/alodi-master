    ...
    <div class="col-lg-6 mx-auto">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('staffs.index') }}" class="btn btn-link text-reset">
                    <i class="las la-angle-left"></i>
                    <span>{{translate('Back to staff list')}}</span>
                </a>
            </div>
            ...
            <form action="{{ route('staffs.update', $staff->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-0 text-right">
                        ...
                        <a href="{{route('staffs.index')}}" class="btn btn-sm btn-outline-info">{{translate('Cancel')}}</a>
                    </div>
                </div>
            </form>
        </div>
